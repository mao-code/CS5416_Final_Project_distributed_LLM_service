...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            max_batch_size_0=int(os.environ.get("MAX_BATCH_SIZE_0", "1")),
            batch_timeout_0=float(os.environ.get("BATCH_TIMEOUT_0", "0.02")),
            max_batch_size_1=int(os.environ.get("MAX_BATCH_SIZE_1", "1")),
            batch_timeout_1=float(os.environ.get("BATCH_TIMEOUT_1", "0.05")),
            max_batch_size_2=int(os.environ.get("MAX_BATCH_SIZE_2", "1")),
